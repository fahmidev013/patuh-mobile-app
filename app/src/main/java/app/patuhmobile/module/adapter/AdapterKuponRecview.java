 ...
 * for SERA
 */
public class AdapterKuponRecview extends RecyclerView.Adapter<AdapterKuponRecview.MyViewHolder>{

    public interface KuponAdapterCallback {
        void onClicked(TukarKupon kupon, int position);

    }


    private List<TukarKupon> kupons;
    private AdapterKuponRecview.KuponAdapterCallback mListener;

    public AdapterKuponRecview(List<TukarKupon> kuponList, AdapterKuponRecview.KuponAdapterCallback callback) {
